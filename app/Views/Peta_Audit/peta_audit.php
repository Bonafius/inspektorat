                                ...
                                <div class="table-responsive">
                                        ...
                                        foreach($surat as $value) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><button class="btn btn-sm btn-success mb-1" type="submit"><i class="fa fa-pencil-square-o mr-1"></i></button>  <button class="btn btn-sm btn-danger mb-1" type="submit"><i class="fa fa-trash mr-1"></i><i class="Delete"></i></button>   <button class="btn btn-sm btn-warning" type="submit"><i class="fa fa-book mr-1"></i></button></td>
                                            </tr>   
                                        <?php } ?>
                                        </tbody>
                                        </table>
